                ...
                <table class="display table table-striped" v-if="ready">
                  ...
                  <tbody>
                    <tr v-for="(item, index) in beritaList" :key="item.id">
                      ...
                      <td>
                        <img
                          :src="`https://backend-sblf.lumirainternational.com/storage/berita/${item.image}`"
                          alt="opportunity"
                          width="200"
                        />
                      </td>
  ...
  methods: {
    ...
    async sendUpdateBerita() {
      try {
        ...
        const response = await axios.post(
          `https://backend-sblf.lumirainternational.com/api/auth/update-berita/${this.updateBerita.idBerita}`,
          formData,
          {
            headers: {
    ...
    async tambahOpportunity() {
      try {
        ...
        const response = await axios.post(
          "https://backend-sblf.lumirainternational.com/api/auth/create-berita",
          formData,
          {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
    ...
    async fetchBerita() {
      ...
      try {
        const response = await axios.get(
          "https://backend-sblf.lumirainternational.com/api/auth/get-berita",
          {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
            },
    ...
    async deleteOpportunity(id) {
      try {
        const response = await axios.delete(
          `https://backend-sblf.lumirainternational.com/api/auth/delete-berita/${id}`,
          {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
            },
